...
%define pname autoconf-spec-verify
...
filename=%{S:autoconf-%{version}.tar.gz}
if [ "$(sha256sum $filename)" != "954bd69b391edc12d6a4a51a2dd1476543da5c6bbf05a95b59dc0dd6fd4c2969" ]; then
